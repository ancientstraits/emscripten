...
long _mmap_js(intptr_t addr, size_t length, int prot, int flags, int fd, size_t offset, int* allocated);
long _munmap_js(intptr_t addr, size_t length, int prot, int flags, int fd, size_t offset);
long _msync_js(intptr_t addr, size_t length, int flags, int fd);
...
int __syscall_mmap2(intptr_t addr, size_t len, int prot, int flags, int fd, size_t off) {
